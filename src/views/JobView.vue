...
<template>
  <BackButton />
  <div v-if="state.isLoading" class="h-50">
    <Loader2 class="animate-spin mt-5 mx-auto size-40 text-green-700" />
  </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-[70%_30%] w-full gap-6">
        <main>
          ...
          >
            ...
            <div
              class="text-orange-700 mb-4 gap-x-1.5 flex items-center justify-center md:justify-start"
            >
              <MapPin class="size-4" />
        ...
        <aside>
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2 bg-green-100 p-2 font-bold md:text-xs lg:text-base">
